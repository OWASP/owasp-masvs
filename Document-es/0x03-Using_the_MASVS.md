...
- Uso como una métrica - Proporciona un estándar dirigido tanto a desarolladores como a propietarios de aplicaciones, el cual puede ser utilizado para comparar aplicaciones en términos de seguridad;
