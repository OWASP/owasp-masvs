...
| -- | -------- | ---------------------- | - | - |
| **2.1** | MSTG-STORAGE-1 | امکانات ذخیره‌سازی ابزارهای احراز هویت سیستم برای ذخیره‌سازی اطلاعات حساس از قبیل PPI، ابزارهای تصدیق هویت کاربر یا کلید‌های رمزنگاری به طور مناسب استفاده شده باشند. | ✓ | ✓ |
