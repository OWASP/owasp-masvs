...
| # | Verified | 1 | 2 | 3 | 4 |
| --- | --- | --- | --- | --- | --- |
| **8.1** | Verify that debugging symbols have been removed from native binaries. (e.g. backup flag, debug etc.)|   | ✓ | ✓ | ✓ |
...
| **8.4** | Verify that the app has been installed from a legitimate source. (e.g. Google/Apple playstore etc.) |   | ✓ | ✓ | ✓ |
