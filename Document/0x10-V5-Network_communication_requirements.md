...
| **5.2** | The TLS settings are in line with current best practices. | ✓ | ✓ |
...
| **5.6** | The app doesn't rely on a single insecure communication channel (email or SMS) for critical operations, such as enrollments and account recovery. |  | ✓ |
