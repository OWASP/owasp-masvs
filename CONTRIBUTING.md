...
5. Once all the chapters are translated, we can start creating a release. The instructions for that are in the [Readme of the Tools folder](https://github.com/OWASP/owasp-masvs/tree/master/tools#adding-another-language "Readme in Tools folder")
