...
### Противодействие прослушке

| # | MSTG-ID | Description | R |
| --- | --- | --- | -- |
| **8.13** | MSTG‑RESILIENCE‑13 | Как средство эшелонированной защиты, после того как канал связи был защищен должным образом,  шифрование ресурсов/полезной нагрузки внутри приложения может быть применено для противодействия прослушке. | ✓ |
...
- Android: Тестирование устойчивости к атакам на стороне клиента - <https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05j-Testing-Resiliency-Against-Reverse-Engineering.md>
- iOS: Тестирование устойчивости к атакам на стороне клиента - <https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06j-Testing-Resiliency-Against-Reverse-Engineering.md>
