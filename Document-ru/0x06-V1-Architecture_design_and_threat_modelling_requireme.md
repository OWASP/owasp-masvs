...
| **1.11** | MSTG‑ARCH‑11 | Ответственная политика раскрытия информации реализована и применяется. |  | ✓ |
| **1.12** | MSTG‑ARCH‑12 | Приложение должно соответствовать законам и правилам конфиденциальности. | ✓ | ✓ |
