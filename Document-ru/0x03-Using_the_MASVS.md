...
**I: Несмотря на то, что мы рекомендуем реализовывать меры защиты MASVS-L1 в каждом приложении - это должно быть решение, согласованное с представителями бизнеса и принятое,полностью основываясь на риск менеджменте.**
...
- Все мобильные приложения хранят чувствительные данные на мобильном устройстве, и в то же время должны поддерживать широкий спектра устройств и версий операционной системы. В этом случае проверка устойчивости к фальсификациям может использоваться в качестве меры эшелонированной защиты, для максимального затруднения извлечения конфиденциальных данных злоумышленником.

- Приложения, с внутренними покупками, в идеале, должны использовать сервер и требования MASVS-L2 для защиты платного контента, однако, иногда бывают случаи, когда невозможно воспользоваться защитой на стороне сервера. В таких случаях, нужно дополнительно использовать требования MASVS-R для того, чтобы увеличить усилия, необходимые для обратного проектирования или же фальсификации данных.