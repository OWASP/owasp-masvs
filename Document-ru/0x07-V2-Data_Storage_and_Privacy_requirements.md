...
| **2.13** | MSTG‑STORAGE‑13 | Чувствительные данные не должны храниться локально на устройстве, вместо этого они должны получаться с сервера, когда необходимы, и хранится только в памяти. |  | ✓ |
...
| **2.15** | MSTG‑STORAGE‑15 |  Локальное хранилище приложения должно быть удалено после превышения определенного количества неудачных попыток аутентификации. |  | ✓ |
