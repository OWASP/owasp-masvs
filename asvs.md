...
Using the Application Security Verification Standard        8

Application Security Verification Levels        8
...
Case Study 1: As a Security Testing Guide        14

Case Study 2: As a secure SDLC        15

Assessing software has achieved a verification level        16

OWASP's stance on ASVS Certifications and Trust Marks        16

Guidance for certifying organizations        16

The role of automated penetration testing tools        16

The role of penetration testing        17

As detailed security architecture guidance        17

As a replacement for off the shelf secure coding checklists        17

As a guide for automated unit and integration tests        17

As secure development training        18

OWASP Projects using ASVS        19

Security Knowledge Framework        19

OWASP Zed Attack Proxy        19

OWASP Cornucopia        19

Detailed Verification Requirements        20

V1: Architecture, design and threat modelling        21
...
V2: Authentication Verification Requirements        23
...
V3: Session Management Verification Requirements        26
...
V4: Access Control Verification Requirements        28
...
V5: Malicious input handling verification requirements        30
...
V6: Output encoding / escaping        34

V7: Cryptography at rest verification requirements        35
...
V8: Error handling and logging verification requirements        37
...
V9: Data protection verification requirements        39
...
V10: Communications security verification requirements        42
...
V11: HTTP security configuration verification requirements        45
...
V12: Security configuration verification requirements        47

V13: Malicious controls verification requirements        48
...
V14: Internal security verification requirements        49

V15: Business logic verification requirements        50
...
V16: Files and resources verification requirements        52
...
V17: Mobile verification requirements        54
...
V18: Web services verification requirements        56
...
Appendix A: What ever happened to…        60

Appendix B: Glossary        66

Appendix C: References        70

Appendix D: Standards Mappings        71
...
## Copyright and License
 ...
 ![](data:image/*;base64,)
...
| --- | --- | --- |
| Andrew van der StockDaniel Cuthbert | Jim Manico | Boy Baukema Ari KesäniemiColin Watson François-Eric Guyomarc'hCristinel Dumitru James HollandGary RobinsonStephen de VriesGlenn Ten CateRiccardo Ten CateMartin KnoblochAbhinav SejpalDavid RyanSteven van der BaanRyan DewhurstRaoul EndresRoberto Martelloni |
