# The OWASP Mobile Application Security Verification Standard
...
- In the SDLC - to establish security requirements to be followed by solutio architects and developers;
